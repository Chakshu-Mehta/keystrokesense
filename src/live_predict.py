...
# ---------- SAME ACCURACY LOGIC AS TRAINING ----------
...
# ---------- WORD-LEVEL MISTAKES (LIKE FEATURE_ENGINEERING) ----------
...
def run_live_prediction():
    ...
    # difficulty_score like earlier: (ref_len - typed_len) + mistakes
    ...
    # Ask only for sleep hours now (self-reported stress will be predicted)
    ...
    # 5. Prepare feature row in SAME ORDER as training
